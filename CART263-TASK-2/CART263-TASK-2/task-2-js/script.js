 ...
 */console.log(document.getElementById("parent"));
    ...
    firstParagraph.textContent = "replacing text"

    /*************************************** */
    /* 2: Select all elements in the HTML that have the class name content-container
     and change the background color ... of first and second ...*/
    /***CODE */
    let elementsHTML = document.getElementsByClassName("content-container");
    elementsHTML[0].style.backgroundColor = "yellow"
    elementsHTML[1].style.backgroundColor = "blue"

    /*************************************** */
    /* 3: Change the src element of the first image element on the page to be ...
    /***CODE */
    let firstImgElement = document.querySelector("img");
    firstImgElement.src = "..."
    ...
    let newGridParent = document.getElementById("new-grid-three");
    ...
    for (let row = 0; row < 10; row++) {
        ...
        for (let col = 0; col < 10; col++) {
            ...
            newReturnedDiv.textContent = remainder;
